    ...
    <section id="hero" className="noisy">
        ...
        <div className="body">
            ...
            <div className="view-cocktails">
                <p className="subtitle">Every cocktail on our menu is a blend of premium infredents, creative, flair, and timeless recipes - designed to delight your senses.</p>
